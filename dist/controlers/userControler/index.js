...
export const registerUser = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (checkUsername || checkEmail) {
      res.status(400).json({
        status: "error",
        massage: "username or email is already used",
      });
      return;
    }
...
export const loginUser = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    if (!username || !password) {
      res.status(400).json({
        status: "error",
        massage: "username and password are required",
      });
      return;
    }
    ...
    if (ckeckUser && matchedPassword) {
      ...
      const setrefreshToken = yield user.updateOne(
        { username: username },
        { $set: { refreshToken } }
      );
...
export const getProductsCart = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const products = yield user.findOne(
      { _id: userData.id },
      { cart: 1, _id: 0 }
    );
    res.json({
      ...
      newToken:
        (_a = res === null || res === void 0 ? void 0 : res.locals) === null ||
        _a === void 0
          ? void 0
          : _a.authenticated,
    });
  });
export const setProductCart = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const userData = req === null || req === void 0 ? void 0 : req.user;
...
export const deleteProductCart = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    ...
    const { cart } = yield user.findOne(
      { _id: userData.id },
      { cart: 1, _id: 0 }
    );
    const filtered = cart.filter(
      (item) =>
        (item === null || item === void 0 ? void 0 : item.id) !== productId
    );
...
export const profile = (req, res) =>
  __awaiter(void 0, void 0, void 0, function* () {
    var _a;
    const userData = req === null || req === void 0 ? void 0 : req.user;
    const user_info = yield user.findOne(
      { _id: userData.id },
